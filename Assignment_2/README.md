...
For this experiment, we will be running all the simulations with the X86 architecture.
...
TimingSimpleCPU is a CPU model that provides a simplified, cycle-accurate timing model of a simple, in-order, single-issue processor. It models the functional behavior of a CPU without considering many of the implementation details that affect performance, such as pipelining and branch prediction.
